...
- **Coupling (provázanost)** - míra závislosti mezi komponentami.
  - cílem je nízký coupling
...
Technika návrhu objektového systému.

Pro každou třídu evidujeme:
- Class
- Responsibilities
- Collaborators

Pomáhá při identifikaci tříd a jejich odpovědností během analýzy domény.

### Domain-Driven Design (DDD)

Přístup k návrhu složitých informačních systémů založený na doménovém modelu.
...
Cílem je sladění modelu systému s reálnou doménou problému.
...
- **Traceability (sledovatelnost požadavků)** - schopnost dohledat vazbu mezi požadavkem, návrhem, implementací a testy.
- Umožňuje zjistit:
  - které části systému jsou ovlivněny změnou požadavku
  - zda má požadavek implementaci
  - zda existují odpovídající testy
- Často se používá traceability matrix.
...
- **Requirements volatility** - míra změn požadavků během projektu.
- Vysoká volatilita zvyšuje náklady vývoje a podporuje použití agilních metodik.
...
- User Story je krátký popis potřeby uživatele:
  - "As a customer I want to export orders so I can create reports."

- Use Case detailně popisuje interakci se systémem:
  - aktéři
  - hlavní scénář
...
User Story odpovídá na otázku "co a proč".
Use Case odpovídá na otázku "jak".
...
- způsob předávání závislostí zvenčí
- komponenta nevytváří své závislosti sama
- podporuje:
  - testovatelnost
  - nízkou provázanost
  - snadnou výměnu implementace

Příklad:
Service závisí na IUserRepository místo konkrétní UserRepository.

### Repository Pattern

- abstrahuje přístup k persistentním datům
- odděluje business logiku od databázové logiky
- poskytuje kolekci objektů nad databází

Výhody:
- jednodušší testování
- výměna databáze bez změn business vrstvy
- centralizace přístupu k datům

### Anti-patterns

Známá špatná řešení opakujících se problémů.

Příklady:
- God Object - jedna třída dělá příliš mnoho věcí
- Spaghetti Code - nepřehledné vazby a tok řízení
- Golden Hammer - použití jednoho řešení na všechny problémy
- Singleton abuse - nadměrné používání singletonů
